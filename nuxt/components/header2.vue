<template>
    <div class="sticky top-0 left-0 right-0 z-[100] h-fit bg-[#1F1F1F] px-8">
        <div class="flex flex-row-reverse md:flex-row justify-between items-center md:h-20">
            <!--LOGO AND BRANDNAME-->
            <img v-if="$device.isDesktopOrTablet" src="/img/soundoclock-logo-bw.png" alt="" class="h-2/3">
...
>>>>>>> mobile-navbar
                ...
                <!--DROPDOWN-->
                <!-- <div class="dropdown flex flex-col gap-2 rounded border-[1px] border-gray-300 bg-white p-4 absolute top-[80px] md:top-[110px] right-[-20px] w-fit whitespace-nowrap shadow-md  z-[100]" :class="{'dropdown--displayed' : showDropdown}">
                    <button class="text-right">Tancar Sessió</button>
                </div> -->
            </div>
            <!--DESKTOP DESIGN-->
            <div v-else class="flex flex-row justify-between items-center gap-5 w-1/2 text-lg">
                ...
                <NuxtLink class="leading-[5rem]" to="https://forms.gle/qKtFKNCgtQjXmpyNA" target="_blank"

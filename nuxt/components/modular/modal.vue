        ...
        <div class="rounded-xl p-8 grid grid-cols-[0.1fr,1fr] bg-white w-[40%] max-w-screen-md text-black">
            ...
            <div class="flex flex-col">
                ...
                <div class="text-gray-600">
                    <slot name="content">
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iure quaerat architecto alias ut tempora repellat nulla, molestias qui, voluptatum aspernatur minus voluptas quas, veritatis expedita nostrum amet harum iste aliquid.</p>
                    </slot>
                </div>
                <div class="w-full">

        ...
        <div class="flex justify-between relative">
            <div class="w-1/2 h-screen flex flex-col justify-center items-center">
                <div class="text-left">
                    ...
                    <p class="text-3xl">El ritme del teu dia, a les teves mans</p>
                    <button @click="loginGoogle" class="flex flex-row gap-x-4 bg-white p-4 my-4 rounded-full">
            ...
            <div class="w-1/2 h-screen flex flex-col justify-end items-center absolute bottom-0 right-0">
                <img src="/img/listening_boy2.png" alt="Vota la cançó" class="w-5/6 drop-shadow-xl text-white">
            </div>
            <img src="/img/fondo.png" alt="" class="absolute w-screen h-screen z-[-100]">
        </div>
    </div>
